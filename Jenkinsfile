...
def promoteQA () {
	...
	openshiftDeploy(depCfg: 'app-qa', namespace: 'phptest-git', verbose: 'false', waitTime: '10', waitUnit: 'min')
...
def promotePROD () {
	...
	openshiftDeploy(depCfg: 'app-prod', namespace: 'phptest-git', verbose: 'false', waitTime: '10', waitUnit: 'min')
